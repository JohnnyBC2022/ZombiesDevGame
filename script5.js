document.addEventListener("keydown", function (event) {
    if (event.key === "ArrowLeft") {
      redireccionar("../wrong-cards/duck-wrong.html");
    } else if (event.key === "ArrowRight") {
      redireccionar("../right-cards/duck-right.html");
    }
  });
  
  function redireccionar(ruta) {
    if (ruta === "../right-cards/duck-right.html") {
      const puntosActuales = obtenerPuntos();
      guardarPuntos(puntosActuales);
    } else if (ruta === "../wrong-cards/duck-wrong.html") {
